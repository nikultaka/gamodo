...
function index() {
  ...
  //   let isInLoginPage = router?.asPath === "/login/";
  //   if (token !== null && token !== undefined && token !== "") {
  //     // window.location.pathname = getPathname;
  //     isInLoginPage && router.push("/home");
  //   }
  // };
        ...
        <div className="loginMainBody">
          ...
          <div className={styles.formInputGroup}>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.forgotPasswordFlex}>
                <div
          ...
          <div className="primaryBtn">
            <MyButton onClick={login_func} isLoading={status !== "idle"}>
              <LoginIcon /> Log In
            </MyButton>
          </div>

          <div className="primaryBtn">{/* <CircularProgress /> */} </div>
